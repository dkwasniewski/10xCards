...
| 9   | Study Session       | `/study`                 | Sequential study of cards via spaced-repetition. **[OPTIONAL FEATURE]**        | Card viewer (front/back flip), rating buttons (1-5), progress bar.                                                                                                                                                                                                                                                                   | Disable rating until back shown; keyboard shortcuts; handle empty queue.                                                |
...
11. User clicks **Study Session** to start spaced-repetition flow (US-010) **[OPTIONAL - not required for MVP]**. Rates recall quality; next card shown until complete.
...
TopBar items (desktop/tablet): Generate & Review | My Flashcards | Study Session **[OPTIONAL]** | Account ▼ (avatar).  
...
| US-010 Study Session View **[OPTIONAL]** | Study Session view, CardViewer, rating buttons                    | Sequential flow & progress bar. Not required for MVP.             |
