...
describe("OpenRouterService", () => {
  ...
  describe("Constructor Validation", () => {
    ...
    it("should normalize baseURL by removing trailing slash", () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith("https://api.example.com/models", expect.any(Object));
    });
    ...
    it("should use default baseURL when not provided", async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith("https://openrouter.ai/api/v1/models", expect.any(Object));
    });
  ...
  describe("Request Building", () => {
    ...
    it("should include required fields in request body", async () => {
      ...
      const messages: OpenRouterMessage[] = [{ role: "user", content: "Test message" }];
