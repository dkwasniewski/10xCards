...
describe("cn() utility function", () => {
  ...
  describe("Conditional Classes", () => {
    ...
    it("should handle ternary operator", () => {
      ...
      const result = cn("button", variant === "primary" ? "bg-blue-500" : "bg-gray-500");
  ...
  describe("Undefined and Null Handling", () => {
    ...
    it("should handle all falsy values", () => {
      const result = cn("class1", undefined, null, false, 0, "", "class2");
      expect(result).toBe("class1 class2");
    });
  ...
  describe("Real-World Component Patterns", () => {
    ...
    it("should handle responsive classes", () => {
      const result = cn("text-sm md:text-base lg:text-lg", "p-2 md:p-4 lg:p-6");
